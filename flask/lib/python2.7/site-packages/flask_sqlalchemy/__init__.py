...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, blog) tuple."""
...
class SQLAlchemy(object):
    ...
    versioning examples.::
        ...
        blog = Flask(__name__)
        db = SQLAlchemy(blog, session_extensions=[VersionedListener()])
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(blog)).
        """
